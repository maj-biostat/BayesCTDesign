...
#'
#' @export
print_table <- function(bayes_ctd_array = NULL, measure = "power", tab_type = "WX|YZ",
                        subj_per_arm_val = NULL, a0_val = NULL, effect_val = NULL,
                        rand_control_diff_val = NULL, print_chg_warn = 1) {
    UseMethod("print_table", bayes_ctd_array)
}
...
#'
#' @export
print_table.bayes_ctd_array <- function(bayes_ctd_array = NULL, measure = "power", tab_type = "WX|YZ", subj_per_arm_val = NULL,
    ...
    if (bayes_ctd_array$objtype == 'simple') {
      ...
      if (print_chg_warn == 1) {
        print("Since simple_sim was used, tab_type was set to WX|YZ")
    ...
    print_table_error_checks(bayes_ctd_array, measure, tab_type, subj_per_arm_val, a0_val, effect_val, rand_control_diff_val)
...
#' in the plot.  The first letter defines the x-axis varible and the second letter
...
#' represented by the second leter.  For example if tab_type equals \code{WX|YZ},
...
#'
#' @export
plot_table <- function(bayes_ctd_array, measure = "power", tab_type = "WX|YZ", smooth = FALSE, plot_out = TRUE, subj_per_arm_val = NULL,
    a0_val = NULL, effect_val = NULL, rand_control_diff_val = NULL, span = 0.75, degree = 2, family = "gaussian", title = NULL, ylim=NULL) {
    UseMethod("plot_table", bayes_ctd_array)
}
...
#'
#' @export
plot_table.bayes_ctd_array <- function(bayes_ctd_array = NULL, measure = "power", tab_type = "WX|YZ", smooth = FALSE,
    ...
    plot_table_error_checks(bayes_ctd_array, measure, tab_type, smooth, plot_out, subj_per_arm_val, a0_val, effect_val,
    ...
    if (tab_type == "WX|YZ") {
        ...
        # option when they want to use the plot_table method to get a table of
        # smoothed results.
        if (plot_out == FALSE) {
            return(table_mat)
        }
