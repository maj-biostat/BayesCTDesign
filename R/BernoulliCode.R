...
#' control data.  The Bernoulli log-likelihood is calculated by modelling \code{data}
#' as a Bernoulli random variable. Not to be called directly by user.
#'
#' @param params  Two element vecter of Bernoulli parameters.  The first and second elements
...
#' #None
#' @keywords internal
bernoulli_sim <- function(trial_reps, subj_per_arm, a0_vals, effect_vals, rand_control_diff, hist_control_data, alpha,
...
#' #None
#' @keywords internal
simple_bernoulli_sim <- function(trial_reps, subj_per_arm, effect_vals, prob1_val, alpha, get_var, get_bias, get_mse) {
