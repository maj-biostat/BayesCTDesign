...
H0: Treatment hazard ratio is 1. Ha: Treatment hazard ratio is not equal to 1.
...
test_table0_6 <- print_table(bayes_ctd_array=weibull_test, measure="power",
...
#The resulting table is a table of power with different sample sizes represented
#in the rows, and different a0 values represented in the columns.
test_table0_7 <- print_table(bayes_ctd_array=weibull_test, measure="power",
...
#The resulting table is a table of power with different sample sizes represented
#in the rows, and different a0 values represented in the columns.
test_table1_0 <- print_table(bayes_ctd_array=weibull_test, measure="power",
...
test_table0_7_1_2 <- print_table(bayes_ctd_array=weibull_test, measure="power",
                          tab_type="WX|YZ", effect_val=0.7,
...
#represented in the rows, and different a0 values represented in the columns.
test_table0_7_0_8 <- print_table(bayes_ctd_array=weibull_test, measure="power",
                          tab_type="WX|YZ", effect_val=0.7,
